...
OTHER_C_FLAGS     := -IC:/msys64/mingw64/include/flatbuffers
...
OTHER_LD_FLAGS    := -static -lflatbuffers
...
CXXFLAGS  := -MD -MP -std=c++17 -Wall -Wno-unused \
	-I$(SRC_DIR) -I$(LIB_DIR) $(OTHER_C_FLAGS) $(UTF8_CPP_C_FLAGS) $(FREETYPE2_C_FLAGS)
