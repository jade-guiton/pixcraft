...
#ifndef FLATBUFFERS_GENERATED_SERIALIZER_SERIALIZE_H_
#define FLATBUFFERS_GENERATED_SERIALIZER_SERIALIZE_H_
...
template<> struct MobTraits<serialize::Player> {
  static const Mob enum_value = Mob_Player;
};

template<> struct MobTraits<serialize::Slime> {
...
struct MobBase FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const serialize::Vec3 *pos() const {
    return GetStruct<const serialize::Vec3 *>(VT_POS);
  }
  const serialize::Vec3 *orient() const {
    return GetStruct<const serialize::Vec3 *>(VT_ORIENT);
  }
  const serialize::Vec3 *speed() const {
    return GetStruct<const serialize::Vec3 *>(VT_SPEED);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<serialize::Vec3>(verifier, VT_POS) &&
           VerifyField<serialize::Vec3>(verifier, VT_ORIENT) &&
           VerifyField<serialize::Vec3>(verifier, VT_SPEED) &&
           verifier.EndTable();
  }
};
...
struct MobBaseBuilder {
  ...
  void add_pos(const serialize::Vec3 *pos) {
    fbb_.AddStruct(MobBase::VT_POS, pos);
  }
  void add_orient(const serialize::Vec3 *orient) {
    fbb_.AddStruct(MobBase::VT_ORIENT, orient);
  }
  void add_speed(const serialize::Vec3 *speed) {
...
inline flatbuffers::Offset<MobBase> CreateMobBase(
    ...
    const serialize::Vec3 *pos = 0,
    const serialize::Vec3 *orient = 0,
    const serialize::Vec3 *speed = 0) {
...
struct Player FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const serialize::MobBase *mob() const {
    return GetPointer<const serialize::MobBase *>(VT_MOB);
  }
  serialize::MovementMode movement_mode() const {
    return static_cast<serialize::MovementMode>(GetField<uint8_t>(VT_MOVEMENT_MODE, 0));
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct PlayerBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_mob(flatbuffers::Offset<serialize::MobBase> mob) {
    fbb_.AddOffset(Player::VT_MOB, mob);
  }
  void add_movement_mode(serialize::MovementMode movement_mode) {
...
inline flatbuffers::Offset<Player> CreatePlayer(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<serialize::MobBase> mob = 0,
    serialize::MovementMode movement_mode = serialize::MovementMode_Normal) {
...
struct World FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<serialize::Chunk>> *chunks() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<serialize::Chunk>> *>(VT_CHUNKS);
  }
...
struct WorldBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_chunks(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<serialize::Chunk>>> chunks) {
...
inline flatbuffers::Offset<World> CreateWorld(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<serialize::Chunk>>> chunks = 0,
...
inline flatbuffers::Offset<World> CreateWorldDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<serialize::Chunk>> *chunks = nullptr,
    const std::vector<uint8_t> *mobs_type = nullptr,
    const std::vector<flatbuffers::Offset<void>> *mobs = nullptr) {
  auto chunks__ = chunks ? _fbb.CreateVector<flatbuffers::Offset<serialize::Chunk>>(*chunks) : 0;
...
inline bool VerifyMob(flatbuffers::Verifier &verifier, const void *obj, Mob type) {
  switch (type) {
    ...
    case Mob_Player: {
      auto ptr = reinterpret_cast<const serialize::Player *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Mob_Slime: {
      auto ptr = reinterpret_cast<const serialize::Slime *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline const serialize::World *GetWorld(const void *buf) {
  return flatbuffers::GetRoot<serialize::World>(buf);
}

inline const serialize::World *GetSizePrefixedWorld(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<serialize::World>(buf);
}

inline bool VerifyWorldBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<serialize::World>(nullptr);
}

inline bool VerifySizePrefixedWorldBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<serialize::World>(nullptr);
}

inline void FinishWorldBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<serialize::World> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_SERIALIZER_SERIALIZE_H_
